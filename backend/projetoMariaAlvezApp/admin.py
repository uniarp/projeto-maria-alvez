...
from .models import (
    ...
    RelatorioAtendimento, RelatorioAcompanhamento, Veterinario, AgendamentoConsulta
)
...
class VeterinarioAdmin(admin.ModelAdmin):
    list_display = ('nome', 'cpf', 'crmv', 'telefone', 'email', 'especialidade')
    search_fields = ('nome', 'cpf', 'crmv', 'email')
    list_filter = ('especialidade',)

@admin.register(AgendamentoConsulta)
class AgendamentoConsultaAdmin(admin.ModelAdmin):
    list_display = ('id', 'tutor', 'get_animais', 'veterinario', 'tipo', 'data', 'hora')
    list_filter = ('tipo', 'data', 'veterinario')
    search_fields = ('tutor__nome', 'veterinario__nome', 'animais__nome')
    ordering = ('-data', 'hora')
    filter_horizontal = ('animais',)

    def get_animais(self, obj):
        return ", ".join([animal.nome for animal in obj.animais.all()])
